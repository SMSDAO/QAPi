...
[
  _make({ name: "express", version: "4.18.2", description: "Fast web framework for Node.js", tier: "starter",
    ...
    audit: { score: 98, passed: true, vulnerabilities: { critical:0, high:0, moderate:0, low:1, info:2 }, cve: [], lastScannedAt: new Date().toISOString(), scanEngine:"qapi-audit-v1", zeroDay:false, contentHash:"a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4" },
  ...
  _make({ name: "lodash", version: "4.17.21", description: "A modern JavaScript utility library", tier: "starter",
    ...
    audit: { score: 95, passed: true, vulnerabilities: { critical:0, high:0, moderate:1, low:2, info:0 }, cve: [], lastScannedAt: new Date().toISOString(), scanEngine:"qapi-audit-v1", zeroDay:false, contentHash:"b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5" },
